    ...
    , ui(new Ui::MainWindow)
{
    ...
    series->append("Responsable resourse humaine",3);//remplacer 3 par e.RRH()
    series->append("chauffeur",3);//remplacer 3 par e.chauffeur()
    series->append("other",3);//remplacer 3 par e.other()
